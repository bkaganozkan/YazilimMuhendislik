...
CREATE TABLE `yazilar` (
  `idyazilar` int NOT NULL AUTO_INCREMENT,
  `yazibaslik` varchar(45) NOT NULL,
  `yazimetin` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idyazilar`),
  UNIQUE KEY `idyazilar_UNIQUE` (`idyazilar`)
...
-- Dump completed on 2020-06-09 17:01:36
